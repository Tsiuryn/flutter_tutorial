...
class PackageShare extends StatefulWidget {
  const PackageShare({Key? key}) : super(key: key);

  @override
  _PackageShareState createState() => _PackageShareState();
}

class _PackageShareState extends State<PackageShare> {
  File? _imageFile;
